        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <p className="text-xl font-semibold text-gray-700">
                  ...
                  <span
                    className={`ml-2 text-sm ${
                      dashboardData.leads.this_month.percentage_change >= 0
                        ? "text-green-500"
                        : "text-red-500"
                    }`}
                  >
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              <div>
                <p className="text-3xl font-bold text-gray-800">
                  {dashboardData.bookings.total_bookings}
                </p>
              ...
              <div>
                <p className="text-xl font-semibold text-gray-700">
                  ...
                  <span
                    className={`ml-2 text-sm ${
                      dashboardData.bookings.this_month.percentage_change >= 0
                        ? "text-green-500"
                        : "text-red-500"
                    }`}
                  >
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              <div>
                <p className="text-3xl font-bold text-gray-800">
                  {dashboardData.conversion_rate.overall}%
                </p>
                <p className="text-sm text-gray-500">Overall Rate</p>
              </div>
              <div>
                <p className="text-xl font-semibold text-gray-700">
                  {dashboardData.conversion_rate.this_month}%
                </p>
                <p className="text-sm text-gray-500">This Month</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              {Object.entries(dashboardData.leads.by_status).map(
                ([status, count]) => (
                  <div
                    key={status}
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              {Object.entries(dashboardData.leads.by_call_status).map(
                ([status, count]) => (
                  <div
                    key={status}
                    className="flex justify-between items-center"
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-gray-800">
                  {dashboardData.bookings.upcoming.next_7_days}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Total Upcoming</span>
                <span className="font-semibold text-gray-800">
                  {dashboardData.bookings.upcoming.total}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              {Object.entries(
                dashboardData.bookings.this_month.by_occasion
              ).map(([occasion, count]) => (
                <div
                  key={occasion}
                  className="flex justify-between items-center"
