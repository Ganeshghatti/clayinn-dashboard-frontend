...
export default function VenueCard({ venue, location_id }) {
    ...
    return (
        <div className="border border-gray-300 rounded-lg shadow-2xl scale-100 hover:scale-95 transition-all duration-300 ease-linear" style={{
            ...
            <Card className="w-64 md:w-full bg-transparent border-none shadow-none" >
                <CardHeader className="flex flex-col items-start justify-start">
                    <CardTitle className="text-clayInnPrimary uppercase ">{venue?.name}</CardTitle>
